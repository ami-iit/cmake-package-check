...
def test_threads():
    ...
    assert cmake_package_check.cmake_package_check("Threads")

def test_non_existing_package():
    assert not cmake_package_check.cmake_package_check("ThisIsNotACMakePackageName")
